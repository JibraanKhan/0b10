...
<head>
    <title>
        ...
        $reload = False;
        ?>            
        deleteRecordsCostume_Inventory.php
...
<?php 
   ...
   // $dbse = "instrument_rentals";
    ...
    $config = parse_ini_file('/home/shelbyyoung/mysqli.ini');
    $dbname = "PPC";
    $conn = new mysqli(
   ...
   // $conn = new mysqli(
    ...
    ?>
    <h1>Showing All Instruments in the Database</h1>
...
function result_to_deletable_table($res) {
    ...
    <?php echo $ncols; ?> columns, <?php echo $nrows; ?> rows.
        ...
        <form action="deleteRecordsCostume_Inventory.php" method="POST">
        <table>
        <thead>
        <tr>
        <th>Delete?</th>

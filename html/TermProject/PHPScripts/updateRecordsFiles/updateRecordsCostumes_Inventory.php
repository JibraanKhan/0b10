...
<html>
    ...
    <?php
        ...
        $query_str = "SELECT * FROM Costumes_Inventory;";
        ...
        if (isset($_POST['Edited'])){
            ...
            $query_spec_str = file_get_contents(get_sql_script_str("Costumes_Inventory", "updateRecords"));
        ...
        if (!$edit || $_POST['Edited']){
            ...
            <form action="updateRecordsCostumes_Inventory.php" method="POST">
            <?php
